...
public class GameInstance : MonoBehaviour {
    ...
    public void SetGameState(GameState state, GameState previousState = GameState.MAIN_MENU) {
        ...
        switch (state) {
            ...
            case GameState.OPTIONS_MENU:
                SetupOptionsMenuState(previousState);
                break;
    ...
    private void SetupOptionsMenuState(GameState previousState = GameState.MAIN_MENU) {
        currentGameState = GameState.OPTIONS_MENU;
        HideAllMenus();
        optionsMenu.SetActive(true);
        optionsMenuScript.SetPreviousState(previousState);
        SetApplicationTargetFrameRate(menusFrameTarget);
    ...
    public void EnterDebugMode() {
        if (!levelManagementScript.LoadLevel("Level1"))
            return;
    ...
    public LevelSelectMenu GetLevelSelectMenu() { return levelSelectMenuScript; }

    public GameObject GetWinMenu() { return winMenu; }
    public WinMenu GetWinMenuScript() { return winMenuScript; }

    public Player GetPlayer() { return playerScript; }

    public CoordinatorHUD GetCoordinatorHUD() { return coordinatorHUDScript; }
    public DaredevilHUD GetDaredevilHUD() {  return daredevilHUDScript; }

    public GameObject GetPlayerGameObject() { return player; }
    ...
    private void AssetLoadedCallback(GameObject asset) {
        ...
        if (asset.CompareTag("Player")) {
            ...
            Validate(winMenuScript, "WinMenu component is missing on entity!", ValidationLevel.ERROR, true);
        ...
        else if (asset.CompareTag("PauseMenu"))
        {
            ...
            Validate(levelSelectMenuScript, "PauseMenu component is missing on entity!", ValidationLevel.ERROR, true);
